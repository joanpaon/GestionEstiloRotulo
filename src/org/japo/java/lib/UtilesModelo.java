...
public class UtilesModelo {
    ...
    // Archivo [CSV] > Modelo
    public static void importarModeloCSV(String archivo,
                                         String separador,
    ...
    public static void importarModeloSBIN(String archivo,
                                          Modelo modeloFin) throws Exception {
    ...
    // Modelo > Archivo [CSV]
    public static void exportarModeloCSV(String archivo,
                                         String separador,
                                         Modelo modelo) throws Exception {
        // Lectura de un fichero de texto
    ...
    public static void exportarModeloSBIN(String ficheroDatos, Modelo modelo) throws IOException {
